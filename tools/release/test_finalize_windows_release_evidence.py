...
def lic(): return {"schema_version":"0.1.0","source_commit":C,"owner_approved":True,"spdx_expression":"LicenseRef-Ergaxiom-Proprietary"}
def canonical_prod():
